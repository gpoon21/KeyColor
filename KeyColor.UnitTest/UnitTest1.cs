...
public class KeyColorGeneratorTests {
    ...
    public void TestGetUniqueColorFromString() {
        KeyColorGenerator generator = new();
    ...
    public void TestGetUniqueColorFromSpan() {
        KeyColorGenerator generator = new();
        byte[] key = [1, 2, 3];
        GeneratedColor color1 = generator[key.AsSpan()];
        GeneratedColor color2 = generator[key.AsSpan()];
    ...
    public void TestGetUniqueColorFromDifferentInputs() {
        ...
        GeneratedColor colorFromKey = generator[key.AsSpan()];
